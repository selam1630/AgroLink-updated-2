...
// Import the token property from useAuth
...
  // Get token and signOut from useAuth
...
            {/* The Cart Icon will now only show if isLoggedIn is true */}
            {isLoggedIn && (
...
            {/* Language Dropdown - Keep this visible */}
            <DropdownMenu>
...
            {/* Auth Buttons desktop - ONLY show if NOT logged in */}
            {!isLoggedIn ? (
...
              {/* Auth Buttons mobile - Conditional Rendering */}
              {!isLoggedIn ? (
...
                    }}
                    className="px-4 py-2 bg-red-500 rounded-lg text-white text-center hover:bg-red-600 font-semibold shadow-lg"
                  >
                    {t("profile.logout")}
                  </button>
                </div>
